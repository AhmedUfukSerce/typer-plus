...
| **Rollover overlap magnitude** (when it occurs) | — | ~30 ms | ~30 ms | next keydown ~30 ms before prior keyup; allow negative Up-Down |
...
| Pause density ρ (fraction IKIs >500 ms) | 0.05–0.15 | — | distribution-shape workstream |
